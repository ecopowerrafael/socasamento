...
export const coupleProfiles = mysqlTable('couple_profiles', {
  ...
  estimatedGuests: int('estimated_guests').default(0),
  estimatedBudget: decimal('estimated_budget', { precision: 12, scale: 2 }).default('0.00'),
  ...
  cityId: int('city_id'),
  stateUf: varchar('state_uf', { length: 2 }),
