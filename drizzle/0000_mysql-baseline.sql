...
--> statement-breakpoint
ALTER TABLE `cities` ADD CONSTRAINT `cities_state_id_states_id_fk` FOREIGN KEY (`state_id`) REFERENCES `states`(`id`) ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE `click_logs` ADD CONSTRAINT `click_logs_photographer_id_photographers_id_fk` FOREIGN KEY (`photographer_id`) REFERENCES `photographers`(`id`) ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE `couple_profiles` ADD CONSTRAINT `couple_profiles_user_id_users_id_fk` FOREIGN KEY (`user_id`) REFERENCES `users`(`id`) ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE `favorites` ADD CONSTRAINT `favorites_photographer_id_photographers_id_fk` FOREIGN KEY (`photographer_id`) REFERENCES `photographers`(`id`) ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE `inspiration_favorites` ADD CONSTRAINT `inspiration_favorites_user_id_users_id_fk` FOREIGN KEY (`user_id`) REFERENCES `users`(`id`) ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE `installment_simulations` ADD CONSTRAINT `installment_simulations_user_id_users_id_fk` FOREIGN KEY (`user_id`) REFERENCES `users`(`id`) ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE `leads` ADD CONSTRAINT `leads_photographer_id_photographers_id_fk` FOREIGN KEY (`photographer_id`) REFERENCES `photographers`(`id`) ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE `photo_location_favorites` ADD CONSTRAINT `photo_location_favorites_user_id_users_id_fk` FOREIGN KEY (`user_id`) REFERENCES `users`(`id`) ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE `photographer_categories` ADD CONSTRAINT `photographer_categories_photographer_id_photographers_id_fk` FOREIGN KEY (`photographer_id`) REFERENCES `photographers`(`id`) ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE `photographer_categories` ADD CONSTRAINT `photographer_categories_category_id_categories_id_fk` FOREIGN KEY (`category_id`) REFERENCES `categories`(`id`) ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE `photographer_favorites` ADD CONSTRAINT `photographer_favorites_user_id_users_id_fk` FOREIGN KEY (`user_id`) REFERENCES `users`(`id`) ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE `photographer_favorites` ADD CONSTRAINT `photographer_favorites_photographer_id_photographers_id_fk` FOREIGN KEY (`photographer_id`) REFERENCES `photographers`(`id`) ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE `photographer_media` ADD CONSTRAINT `photographer_media_photographer_id_photographers_id_fk` FOREIGN KEY (`photographer_id`) REFERENCES `photographers`(`id`) ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE `photographer_packages` ADD CONSTRAINT `photographer_packages_photographer_id_photographers_id_fk` FOREIGN KEY (`photographer_id`) REFERENCES `photographers`(`id`) ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE `photographer_plan_periods` ADD CONSTRAINT `photographer_plan_periods_photographer_id_photographers_id_fk` FOREIGN KEY (`photographer_id`) REFERENCES `photographers`(`id`) ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE `photographer_subscriptions` ADD CONSTRAINT `photographer_subscriptions_photographer_id_photographers_id_fk` FOREIGN KEY (`photographer_id`) REFERENCES `photographers`(`id`) ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE `photographer_subscriptions` ADD CONSTRAINT `photographer_subscriptions_plan_id_subscription_plans_id_fk` FOREIGN KEY (`plan_id`) REFERENCES `subscription_plans`(`id`) ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE `photographers` ADD CONSTRAINT `photographers_user_id_users_id_fk` FOREIGN KEY (`user_id`) REFERENCES `users`(`id`) ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE `photography_quote_requests` ADD CONSTRAINT `photography_quote_requests_user_id_users_id_fk` FOREIGN KEY (`user_id`) REFERENCES `users`(`id`) ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE `photography_quote_requests` ADD CONSTRAINT `photography_quote_requests_photographer_id_photographers_id_fk` FOREIGN KEY (`photographer_id`) REFERENCES `photographers`(`id`) ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE `photography_quote_simulations` ADD CONSTRAINT `photography_quote_simulations_user_id_users_id_fk` FOREIGN KEY (`user_id`) REFERENCES `users`(`id`) ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE `recent_weddings` ADD CONSTRAINT `recent_weddings_photographer_id_photographers_id_fk` FOREIGN KEY (`photographer_id`) REFERENCES `photographers`(`id`) ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE `reviews` ADD CONSTRAINT `reviews_photographer_id_photographers_id_fk` FOREIGN KEY (`photographer_id`) REFERENCES `photographers`(`id`) ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE `subscription_history` ADD CONSTRAINT `subscription_history_photographer_id_photographers_id_fk` FOREIGN KEY (`photographer_id`) REFERENCES `photographers`(`id`) ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE `subscription_payments` ADD CONSTRAINT `subscription_payments_subscription_id_photographer_subscriptions_id_fk` FOREIGN KEY (`subscription_id`) REFERENCES `photographer_subscriptions`(`id`) ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE `subscription_payments` ADD CONSTRAINT `subscription_payments_photographer_id_photographers_id_fk` FOREIGN KEY (`photographer_id`) REFERENCES `photographers`(`id`) ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE `subscription_payments` ADD CONSTRAINT `subscription_payments_plan_id_subscription_plans_id_fk` FOREIGN KEY (`plan_id`) REFERENCES `subscription_plans`(`id`) ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE `subscription_plan_features` ADD CONSTRAINT `subscription_plan_features_plan_id_subscription_plans_id_fk` FOREIGN KEY (`plan_id`) REFERENCES `subscription_plans`(`id`) ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE `subscription_plan_items` ADD CONSTRAINT `subscription_plan_items_plan_id_subscription_plans_id_fk` FOREIGN KEY (`plan_id`) REFERENCES `subscription_plans`(`id`) ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE `subscription_provider_links` ADD CONSTRAINT `subscription_provider_links_subscription_id_photographer_subscriptions_id_fk` FOREIGN KEY (`subscription_id`) REFERENCES `photographer_subscriptions`(`id`) ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE `subscription_provider_links` ADD CONSTRAINT `subscription_provider_links_photographer_id_photographers_id_fk` FOREIGN KEY (`photographer_id`) REFERENCES `photographers`(`id`) ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE `subscriptions` ADD CONSTRAINT `subscriptions_photographer_id_photographers_id_fk` FOREIGN KEY (`photographer_id`) REFERENCES `photographers`(`id`) ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE `subscriptions` ADD CONSTRAINT `subscriptions_plan_id_subscription_plans_id_fk` FOREIGN KEY (`plan_id`) REFERENCES `subscription_plans`(`id`) ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE `wedding_budget_categories` ADD CONSTRAINT `wedding_budget_categories_budget_id_wedding_budgets_id_fk` FOREIGN KEY (`budget_id`) REFERENCES `wedding_budgets`(`id`) ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE `wedding_budgets` ADD CONSTRAINT `wedding_budgets_user_id_users_id_fk` FOREIGN KEY (`user_id`) REFERENCES `users`(`id`) ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE `wedding_events` ADD CONSTRAINT `wedding_events_user_id_users_id_fk` FOREIGN KEY (`user_id`) REFERENCES `users`(`id`) ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE `wedding_expenses` ADD CONSTRAINT `wedding_expenses_user_id_users_id_fk` FOREIGN KEY (`user_id`) REFERENCES `users`(`id`) ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE `wedding_gifts` ADD CONSTRAINT `wedding_gifts_user_id_users_id_fk` FOREIGN KEY (`user_id`) REFERENCES `users`(`id`) ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE `wedding_guests` ADD CONSTRAINT `wedding_guests_user_id_users_id_fk` FOREIGN KEY (`user_id`) REFERENCES `users`(`id`) ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE `wedding_rsvps` ADD CONSTRAINT `wedding_rsvps_wedding_website_id_wedding_websites_id_fk` FOREIGN KEY (`wedding_website_id`) REFERENCES `wedding_websites`(`id`) ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE `wedding_style_quiz_results` ADD CONSTRAINT `wedding_style_quiz_results_user_id_users_id_fk` FOREIGN KEY (`user_id`) REFERENCES `users`(`id`) ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE `wedding_tasks` ADD CONSTRAINT `wedding_tasks_user_id_users_id_fk` FOREIGN KEY (`user_id`) REFERENCES `users`(`id`) ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE `wedding_timeline_items` ADD CONSTRAINT `wedding_timeline_items_timeline_id_wedding_timelines_id_fk` FOREIGN KEY (`timeline_id`) REFERENCES `wedding_timelines`(`id`) ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE `wedding_timelines` ADD CONSTRAINT `wedding_timelines_user_id_users_id_fk` FOREIGN KEY (`user_id`) REFERENCES `users`(`id`) ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
