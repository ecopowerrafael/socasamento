...
ALTER TABLE `subscription_payments` ADD CONSTRAINT `fk_sub_payments_subscription` FOREIGN KEY (`subscription_id`) REFERENCES `photographer_subscriptions`(`id`) ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE `subscription_provider_links` ADD CONSTRAINT `fk_sub_provider_subscription` FOREIGN KEY (`subscription_id`) REFERENCES `photographer_subscriptions`(`id`) ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
